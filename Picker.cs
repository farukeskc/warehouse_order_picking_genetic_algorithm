...
namespace ComparisonOfOrderPickingAlgorithms
{
    public class Picker
    {
        ...
        public Picker(Coordinate depotLocation)
        {
            ...
            this.criticalPoints = new List<Coordinate>();
        ...
        public void goToLocation(int aLoc, int bLoc, Problem room)
        {
            ...
            if (aLoc == this.AInfo)
            {
                ...
                {
                    criticalPoints.Add(new Coordinate(this.BInfo, (AInfo == 2) ? 99: 0));
                    criticalPoints.Add(new Coordinate(bLoc, (AInfo == 2) ? 99 : 0));
            ...
            else
            {
                if (bLoc == this.BInfo)
                {
                    criticalPoints.Add(new Coordinate(this.BInfo, this.AInfo));
                    criticalPoints.Add(new Coordinate(this.BInfo, aLoc));
                    ...
                    if (aLoc > this.AInfo)
                    {
                        ...
                        {
                            collectAisle(false, false, false, room);
                    ...
                    else // aLoc can not be same with this.AInfo already...
                    {
                        for (int a = this.AInfo; a > aLoc; a = a - 1)
                        {
                            collectAisle(true, false, false, room);
        ...
        public void collectLGAisle(bool up, Aisle aisle, Problem problem)
        {
            ...
            List<Item> sortedAisleItems = problem.sortAisleItems(problem.getNonPickedAisleItems(aPos, this.BInfo, false, false));
            ...
            if (up)
            {
                this.criticalPoints.Add(new Coordinate(this.BInfo, aisle.HighLargestGap));
                this.criticalPoints.Add(new Coordinate(this.BInfo, 99));
            ...
            {
                this.criticalPoints.Add(new Coordinate(this.BInfo, aisle.LowLargestGap));
                this.criticalPoints.Add(new Coordinate(this.BInfo, 0));
        ...
        public void collectAisle(bool up, bool enterExitSame, bool isMidpoint, Problem problem)
        {
            int aPos;
            if (up)
            {
            ...
            List<Item> sortedAisleItems = problem.sortAisleItems(problem.getNonPickedAisleItems(aPos, this.BInfo, isMidpoint, up));
            if (sortedAisleItems.Count == 0)
            {
                return;
            }
            ...
            if (enterExitSame)
            {
                if (up)
                {
                    this.criticalPoints.Add(new Coordinate(this.BInfo, sortedAisleItems.ElementAt(sortedAisleItems.Count() - 1).DInfo));
                    this.criticalPoints.Add(new Coordinate(this.BInfo, 99));
